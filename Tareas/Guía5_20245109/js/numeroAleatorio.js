...
function generarNumeroAleatorio() {
    ...
    if(intentos <= numeroIntentos) {
        ...
        if (numero == numeroAleatorio) {
            ...
            mensaje = `Sú numero de intentos ha terminado.
            El número oculto era: ${numeroAleatorio}. Refresque la página para volver a jugar.`;
        } else {
            if (numero < numeroAleatorio) {
                mensaje = `Vuelve a intentar. Quedan ${numeroIntentos - intentos} intentos. Además el número aleatorio es más alto.`;
            } else {
                mensaje = `Vuelve a intentar. Quedan ${numeroIntentos - intentos} intentos. Además el número aleatorio es más bajo.`;
            }
